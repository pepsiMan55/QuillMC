...
public class ServerGUI extends JComponent implements ICommandListener {
	...
	public static void initGui(net.minecraft.server.QuillMinecraftServer var0) {
		try {
	...
	public ServerGUI(net.minecraft.server.QuillMinecraftServer var1) {
		this.mcServer = var1;
	...
	static net.minecraft.server.QuillMinecraftServer getMinecraftServer(ServerGUI var0) {
